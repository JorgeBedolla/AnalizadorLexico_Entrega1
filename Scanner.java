...
public class Scanner {
    ...
    public boolean closeStringFlag = true;
    ...
    List<Token> scanTokens(){
        ...
        while(i < cadena.length){
            ...
            switch(estado){
                ...
                case 6:
                    ...
                    tokens.add(new Token(TipoToken.NUMBER, buffer, Double.parseDouble(buffer), linea));
                    buffer = "";
                    estado = 0;
                    i = i - 2;
                    break;
                ...
                case 15:
                    //CREAMOS UNA CADENA
                    tokens.add(new Token(TipoToken.STRING, buffer, buffer.replaceAll("\"", ""),linea));
                    buffer = "";
                    i = i - 1;
                    estado = 0;
                    break;
         ...
         */
        if(!closeStringFlag){
            System.out.println("ERROR: La cadena debe cerrarse");
            mensajeError = "Cadena sin cerrar";
            return null;
        }
    ...
    public static Token buscarSigno(char c,int linea){
        ...
        switch(c){
            case '(':
                t = new Token(TipoToken.PAR_IZQ, "(" ,null, linea);
                break;
            case ')':
                t = new Token(TipoToken.PAR_DER, ")" ,null, linea);
                break;
            case '{':
                t = new Token(TipoToken.LLAVE_IZQ, "{" ,null, linea);
                break;
            case '}':
                t = new Token(TipoToken.LLAVE_DER, "}" ,null, linea);
                break;
            case ',':
            ...
            case ';':
                ...
                break;
            case '-':
                t = new Token(TipoToken.RES, "-" ,null, linea);
                break;
            case '+':
                t = new Token(TipoToken.SUM, "+" ,null, linea);
                break;
            case '*':
